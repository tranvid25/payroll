...
<body style="margin: auto;  width: 80%;  padding: 10px;">
    ...
    <div style="margin: auto;  background-color: aliceblue; padding: 30px ">
        ...
        <div style="text-align: start ; padding-top: 10px">Mọi thắc mắc xin liên hệ: TQV.datvexemphim@gmail.com</div>
        <div style="text-align: end ; padding-top: 10px">TQV XIN CHÂN THÀNH CẢM ƠN QUÝ KHÁCH ĐÃ SỬ DỤNG DỊCH VỤ !</div>
